...
IT's a way to tell the browser and anyone looking at your code what it is supose to look like.

2. Name two big differences between ```display: block;``` and ```display: inline;```. 

Inline to help things sit next to one another and block doesn't sit next to each other 
...
It allows team members towork on projects adding different branches and seeing all of the stuff people are working on.
